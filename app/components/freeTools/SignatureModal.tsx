    ...
    >
      <Box sx={style}>
        ...
        <div className="flex flex-col md:flex-row gap-3 mt-4">
          ...
          >
            <button className="relative z-10 inline-flex items-center justify-center w-full md:w-auto px-6 py-2 text-lg text-white font-bold transition-all duration-200 bg-[#ff2d55] border-2 border-black sm:w-auto rounded-xl font-pj hover:bg-white hover:text-[#ff2d55] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 shadow-[1px_1px_10px_4px_#e2e8f0]">
              Copy Signature
            </button>
          </ReactCopyToClipboard.CopyToClipboard>
        </div>
