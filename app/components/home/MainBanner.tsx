...
const MainBanner = () => {
  return (
    <section className="py-8 sm:py-12 md:py-10 lg:py-10 xl:py-10">
      <div className="container flex flex-col-reverse items-center justify-center mx-auto md:flex-row">
        <div className="lg:w-1/2 animate__animated animate__fadeInLeft mb-8 md:mb-0 md:w-1/2">
          <h1 className="max-w-xl lg:text-[2.9rem] leading-none text-teal-500 font-extrabold text-center lg:text-5xl lg:text-left lg:leading-tight mb-5">
